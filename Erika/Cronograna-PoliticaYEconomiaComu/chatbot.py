#!/usr/bin/env python3
"""Chatbot RAG sobre el cronograma de la materia Politíca y Economía de la Comunicación.

Es lo mismo que consulta-unica.py, pero conversado. La diferencia que importa:
consulta-unica.py vuelve a vectorizar los 37 fragmentos en cada corrida, y acá
...
DATOS = Path(__file__).resolve().parent / "datos" / "Cronograma-PolyEco.md"
...
def partir_en_entradas(texto):
    """Un fragmento por entrada del cronograma, con la clase adelante.
...
def main():
    ...
    print("(consulta-unica.py, en cambio, los vuelve a calcular en cada corrida.)")
